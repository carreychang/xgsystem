...
class wencai_threading_data:
    def __init__(self,text='趋势向上的标的,在5日均线上方,成交量大于1亿,市场热点,剔除创业板',
                on=['股票简称','代码']):
        '''
        问财经条件选股合并系统，多线程
        问财多条件选股合并,有会员的不用管
    ...
    def get_result(self):
        ...
        获取结果
        '''
        if self.data_1.shape[0]==self.data.shape[0]:
            return pd.DataFrame()
        else:
            return self.data
if __name__=='__main__':
    ...
    测试
    '''
    data=wencai_threading_data(text='趋势向上的标的，在5日均线上方，成交量大于1亿，市场热点，剔除创业板')  
