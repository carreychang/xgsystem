...
class lude_spot_data_selenium:
    def __init__ (self,down_path=r'C:\Users\lxg123456\Downloads'):
        ...
        # 指定绝对路径的方式（可选）
        self.browser.get('https://lude.cc/table')
        self.browser.maximize_window()
        #2分钟内完成手动登录因子设置，因子随便设置
        time.sleep(120)
    ...
    def click_spot_select(self,x=852,y=413):
        ...
        点击盘中选股
        '''
        self.browser.find_element(by=By.XPATH,value='/html/body/div[1]/div/div/section/main/div/div[1]/div/div[2]/div[5]/button/span').click()
    def after_disk_selection(self,x=709,y=417):
        '''
        盘后选择
        '''
        self.browser.find_element(by=By.XPATH,value='/html/body/div[1]/div/div/section/main/div/div[1]/div/div[2]/div[4]/button/span').click()
    def down_table(self,x=572,y=418):
        '''
        点击下载表格
        '''
        self.browser.find_element(by=By.XPATH,value='/html/body/div[1]/div/div/section/main/div/div[1]/div/div[2]/div[3]/button/span').click()
...
if __name__=='__main__':
    models=lude_spot_data_selenium()
    time.sleep(5)
