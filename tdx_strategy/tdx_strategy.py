...
def take_advantage_of_the_trend(df):
    ...
    DRAWTEXT(CROSS(ABC7,ABC14) AND{微信公众号:数据分析与运用}ABC,L*0.98,' ★买'),COLORMAGENTA;
    ...
    DRAWNUMBER(ISLASTBAR,FK,FK){微信公众号:数据分析与运用},COLOR0000FF;
...
if __name__=='__main__':
    df=ak.stock_zh_a_daily(symbol='sh600031',start_date='20240101')
    print(take_advantage_of_the_trend(df))
